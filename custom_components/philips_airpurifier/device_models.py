...
_CONFIG_AC2221 = DeviceModelConfig(
    ...
    speeds={
        PresetMode.SPEED_1: {PhilipsApi.NEW2_POWER: 1, PhilipsApi.NEW2_MODE_B: 17},
        PresetMode.SPEED_2: {PhilipsApi.NEW2_POWER: 1, PhilipsApi.NEW2_MODE_B: 2},
        PresetMode.SPEED_3: {PhilipsApi.NEW2_POWER: 1, PhilipsApi.NEW2_MODE_B: 19},
        PresetMode.SPEED_4: {PhilipsApi.NEW2_POWER: 1, PhilipsApi.NEW2_MODE_B: 4},
        PresetMode.SPEED_5: {PhilipsApi.NEW2_POWER: 1, PhilipsApi.NEW2_MODE_B: 18},
    },
    switches=[],
    lights=[],
    selects=[],
